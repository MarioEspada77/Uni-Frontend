     ...
     async componentDidMount(){
         try {
            ...
            console.log("posts", posts);
             ...
             this.setState({loading: false, error: "En estos momentos no ha sido posible cargar las publicaciones."})
         }
     }
    render() { 
        ...
        <div className="container-fluid container-margins">
            <div className="row" style={{marginTop: "40px"}}>
                ...
                {!error ? (!loading && <Posts posts={posts} ></Posts>) : <div><p>Error al cargar las publicaciones.</p></div>}
