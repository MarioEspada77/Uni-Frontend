        ...
        return (
            <div className="feed" style={{marginBottom: "20px"}}>
                <div className="card-feed post-margin">
                    <div className= "justify-content-xl-start align-items-xl-start card-username"><img class="rounded-circle" src={imageprofile} style={{width: "40",height: "40"}} alt="user profile image"/>
                        <p className="user-name">{post.username.username}<span>&nbsp;<i class="fa fa-check-circle icon-verified" style={{height: "10px"}}></i></span></p>
                        ...
                        <div className="dropdown">
                            ...
                            <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a className="dropdown-item" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" onClick={this.handleReport}>Reportar</a>
                                <a className="dropdown-item" href="#">Another action</a>
                                <a className="dropdown-item" href="#">Something else here</a>
                                {post.username._id === user._id && 
                                <>
                                    <a className="dropdown-item" href="#">Eliminar</a>
                                    <a className="dropdown-item" href="#">Fijar en tu perfil</a>
                                </>
                                }
                            </div>
                        </div>
                ...
                <div className="card-reactions">
                    ...
                    <i className="icon-share-alt share-icon">
                    </i><span className="likes-count">12</span>
                ...
                <div className="post-reactions">
                    <div className="item-reaction-post" onClick={this.handleLike}>
                        <span className="like-button item-reaction-post">
                            {liked ? <i class="fas fa-heart like-active"></i> : <i class="fa fa-heart-o like-deactivated" aria-hidden="true"></i>}
                            
                            <span style={{marginLeft: "4px"}}>Me gusta</span>
                        </span>
                    </div>
                    <div className="item-reaction-post"><span className="like-button"><i className="icon-bubble comment-bubble"></i><span style={{marginLeft: "4px"}}>Comentar</span></span>
                    </div>
                    <div className="item-reaction-post"><span className="like-button"><i className="icon-share-alt like-active"></i><span style={{marginLeft: "4px"}}>Compartir</span></span>
                    </div>
                </div>
            </div>
            </div>
